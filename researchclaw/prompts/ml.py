...
_DEFAULT_STAGES: dict[str, dict[str, Any]] = {
    ...
    "experiment_design": {
        ...
        "user": (
            ...
            "- DO NOT plan experiments requiring more GPUs than the allocation "
            "described above or more than "
            "{time_budget_sec}s.\n"
    ...
    "code_generation": {
        ...
        "user": (
            ...
            "  * Replacing real benchmark/model inference with a synthetic DGP, "
            "simulated trajectory, mock LLM, or random correctness/calibration/reward\n"
            "  * Writing that a later 'production experiment' will replace the "
            "generated code — Stage 10 itself must be the real experiment\n"
